...
function Twitter(options) {
	...
	var defaults = {
		...
		trend_base: 'https://api.twitter.com/1.1/trends/closest.json',   //jay entry
...
Twitter.prototype.search = function(q, params, callback) {
	...
	var fin = this.get(url, params, callback);
	console.log ( ' fin search =', fin); 	
